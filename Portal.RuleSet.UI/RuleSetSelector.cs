...
namespace Portal.RuleSet.UI
{
    internal partial class RuleSetSelector : Form
    {
        ...
        private readonly List<RuleSetData> ruleSetDataCollection = new List<RuleSetData>();
        private readonly List<RuleSetData> selectedRuleSetDataCollection = new List<RuleSetData>();
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in ruleSetsListBox.SelectedItems)
            {
            ...
            if (ValidateUniqueness(out duplicateRuleSetName))
            {
                Close();
        ...
        {
            foreach (var data1 in selectedRuleSetDataCollection)
            {
                foreach (var data2 in selectedRuleSetDataCollection)
                {
